...
ggsave("Figures_rr/gurobi/ThaVnm.pdf",  dpi = 1000, 
...
ggsave("Figures_rr/gurobi/ThaVnm_WDPA.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_AllWDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(44, 50, 75, 100), lm = c(44, 100))

ggsave("Figures_rr/gurobi/ThaVnm_AllWDPA.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)
...
ggsave("Figures_rr/gurobi/PNG.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_WDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(14, 50, 75, 100), lm = c(14, 100))

ggsave("Figures_rr/gurobi/PNG_WDPA.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)
...
ggsave("Figures_rr/gurobi/PNG_AllWDPA.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)
...
ggsave("Figures_rr/gurobi/SEAsia.pdf",  dpi = 1000, 
       width = 8, height = 6, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_WDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(14, 25, 50, 75, 100), lm = c(14, 100))

ggsave("Figures_rr/gurobi/SEAsia_WDPA.pdf",  dpi = 1000, 
       width = 8, height = 6, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_AllWDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(44, 50, 75, 100), lm = c(44, 100))

ggsave("Figures_rr/gurobi/SEAsia_AllWDPA.pdf",  dpi = 1000, 
       width = 8, height = 6, units = "cm", limitsize = FALSE)
...
ggsave("Figures_rr/gurobi/RedSea.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_WDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(14, 25, 50, 75, 100), lm = c(14, 100))

ggsave("Figures_rr/gurobi/RedSea_WDPA.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_AllWDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(44, 50, 75, 100), lm = c(44, 100))

ggsave("Figures_rr/gurobi/RedSea_AllWDPA.pdf",  dpi = 1000, 
       width = 6, height = 7, units = "cm", limitsize = FALSE)
...
ggsave("Figures_rr/gurobi/LatAm.pdf",  dpi = 1000, 
       width = 8, height = 6, units = "cm", limitsize = FALSE)

plot <- fPlot_Rank(result_BioServ_WDPA_rmPA, limits = limits, palet = "viridis", 
                   brk = c(14, 25, 50, 75, 100), lm = c(14, 100))

ggsave("Figures_rr/gurobi/LatAm_WDPA.pdf",  dpi = 1000, 
       width = 8, height = 6, units = "cm", limitsize = FALSE)
...
ggsave("Figures_rr/gurobi/LatAm_AllWDPA.pdf",  dpi = 1000, 
       width = 8, height = 6, units = "cm", limitsize = FALSE)
